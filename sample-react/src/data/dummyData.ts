...
export const flows = [
  ...
  {
    title: '미션과 보상 등록',
    description: '부모가 자녀에게 할 일과 보상 금액을 걸고 미션을 보냅니다.',
    stage: '미션',
  },
  {
    title: '승인 후 보상 지급',
    description: '자녀가 완료 제출하면 부모 승인 후 부모 지갑에서 자녀 지갑으로 지급합니다.',
    stage: '보상',
  },
  {
    title: '미션 캘린더',
    description: '부모와 자녀가 수행 날짜 기준으로 월별 미션과 지급 상태를 확인합니다.',
    stage: '캘린더',
  },
  {
    title: '아이 캐시북 기록',
    description: '자녀는 어떤 미션으로 돈을 벌었는지 기록과 잔액을 확인합니다.',
    stage: '기록',
  },
];
